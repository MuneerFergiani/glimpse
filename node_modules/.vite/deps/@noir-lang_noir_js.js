...
function __wbg_adapter_26(arg0, arg1, arg2, arg3) {
  wasm2.wasm_bindgen__convert__closures__invoke2_mut__h345d08f7c40b28d9(arg0, arg1, addHeapObject2(arg2), addHeapObject2(arg3));
}
  ...
  imports.wbg.__wbg_forEach_942772130a8d06a6 = function(arg0, arg1, arg2) {
    try {
      ...
      var cb0 = (arg02, arg12) => {
        ...
        state0.a = 0;
        try {
          return __wbg_adapter_26(a, state0.b, arg02, arg12);
        } finally {
          state0.a = a;
        }
      };
...
var Noir = class {
  ...
  async destroy() {
    var _a;
    await ((_a = this.backend) == null ? void 0 : _a.destroy());
  }
  getBackend() {
